...
class AnalogGaugeWidget(QWidget):
    ...
    def rescale_method(self):
        ...
        # SET FONT SIZE
        ################################################################################################
        self.scale_fontsize = int(self.initial_scale_fontsize * self.widget_diameter / 425)
        self.value_fontsize = int(self.initial_value_fontsize * self.widget_diameter / 300)
